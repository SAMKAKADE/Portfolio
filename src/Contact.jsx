...
function Contact() {
  return (
    <>
    <div id="contact" className={styles.aboutSection} data-aos="fade-up" data-aos-once="false" data-aos-delay="700">
      <div className="container ">
        {/* Heading Section */}
        <div className={`row text-center mb-5`}>
          <div className="col">
            <p className={`mt-4 ${styles.introText}`}>CONTACT US</p>
            <h2 className="fw-bold">Have a Project?</h2>
          ...
          <div className="col-lg-4">
            ...
            <div className="d-flex mb-4">
              ...
              <div className="ms-3">
                ...
                <p className="text-success m-0">+91 - 8767715551</p>
              </div>
            </div>
            ...
            <div className="d-flex mb-4">
              ...
              <div className="ms-3">
                ...
                <p className="text-success m-0">samarthkakade11@gmail.com</p>
              </div>
            </div>
            ...
            <div className="d-flex mb-4">
              ...
              <div className="ms-3">
                ...
                <p className="text-success m-0">yoursite.com</p>
              </div>
            </div>
          </div>
        </div>
